...
/** Official Google Ads mark (Simple Icons), inlined so the icon works offline/self-hosted. */
function GoogleAdsIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="#4285F4" className={className} role="img" aria-label="Google Ads">
